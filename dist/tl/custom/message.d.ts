...
export declare class CustomMessage extends SenderGetter {
    ...
    click({ i, j, text, filter, data, sharePhone, shareGeo, password, }: ButtonClickParam): Promise<string | Api.TypeUpdates | Api.Message | Api.messages.BotCallbackAnswer | null | undefined>;
    /**
